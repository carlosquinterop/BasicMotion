...
QT_MOC_LITERAL(1, 13, 20), // "updateJoystickAction"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 1), // "i"
QT_MOC_LITERAL(4, 37, 4), // "int*"
QT_MOC_LITERAL(5, 42, 4) // "axes"

    },
    "workerThread\0updateJoystickAction\0\0i\0"
    "int*\0axes"
};
...
void workerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateJoystickAction((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int*(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (workerThread::*_t)(int , int * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&workerThread::updateJoystickAction)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void workerThread::updateJoystickAction(int _t1, int * _t2)
{
